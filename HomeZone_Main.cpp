...
multiset<int> multi_st;                                                                                      // stl


class Card_view_Adding// class
{
private:
    char line[600];
    int N = 800;
public:
    int added_to_cart(int flag,string what_file)// cart a item num
    {
        int counter=0,c_ter=0;
        ifstream fout;           //reading from the file
        fout.open(what_file);
            ...
            while (fout)
            {
                ...
                if(c_ter==counter)
                {
                    if(state_of_cart)
                    {
                        ...
                        ofstream card_view("card_view.txt",ios::out);                                                   //  file handling
                        card_view<<line<<endl;
                    }
                    else
                    {
    ...
    void choose_country()
    {
        ...
        case 3:
            ...
            break;
                                      ...
                                      //inheritance
class Buying_Land : public DashBoard //plymorphism                                                                             //    polymorphism  as well as inheritance
{
    char line[800];
    int N=1000;                                                    /*The use of virtual functions and the override keyword indicates the use of polymorphism,
                                                                      as objects of Buying_Land and House_Rent can be treated as objects of the DashBoard base class.*/
    int city_pos;
    ...
    void choose_city(int flag)
    {
        ...
        else
        {
            cout << endl << "Wrong option is choosed !!" << endl;
                                      ...
                                      //polymorphism
class House_Rent : public DashBoard// inheritance
{
    char line[600];
    int N = 800;
    int city_pos;
...
public:
    ...
    void login()                                                                                    // Member Function Used    ******
    {
        ...
        ifstream input("database.txt");// File
        while(input>>u>>p)
        {
            if(u==user && p==pass)
    ...
    void forgot()
    {
        ...
        case 1:
        {
            ...
            ifstream searchu("database.txt");//File
            while(searchu>>su>>sp)
            {
                if(su==searchuser)
                {
            ...
            else
            {
                ...
                cout<<"\nPlease kindly contact to Admin Of this App (Moin 2107111)\n";
                cin.get();
                cin.get();
...
void calling_loging_class()
{
    ...
    case 4:
        ...
        cout<<"\nThanks for using our App. Created By : Moin 2107111)\n";
        break;
    default:
        //system("cls");
...
inline void function_for_some()
{
    ...
    else if(flag == 2)
    {
        DashBoard *root;
        House_Rent rent_obj;
        House_Rent *rent = dynamic_cast<House_Rent*>(&rent_obj);// rtti
...
class Make_invoice// operator overloading
{
...
public:
    void calculate_total_cost()
    {
        ...
        while(input >> str)
        {
            ...
            else if(flag2 == true)
            {
                ...
                calculation_of_dolars(val);
                calculation_of_items(counter);
            }
    ...
    int get_totoal_count()
    {
        return items_count;
                                                                        ...
                                                                        /* In the cart_operation class, a friend function is declared. This function is used to overload the
                                                                         stream insertion operator (<<) and allows external code to access the private members of the cart
                                                                         _operation class for custom output formatting.*/
    friend ostream& operator<<(ostream &out,cart_operation &ob);


                                                                                                                   //operator overloading  (line 605) *******
};


ostream& operator << (ostream &out, cart_operation &ob) //operator overloading
{
...
int main()
{
    cout<< "A lab project by Mohammad MOin Uddin Moin\n\n\nRoll :2107111\n\n\n";
    calling_loging_class();
    ...
    if(flag == 1)
    {
        cout << object;                                                                         // Operator Overloading (line 605)       ***********
        ...
        else
        {
            ...
            Make_invoice invoice(0,1000);// costructor
            invoice.make_final_card_list();
            invoice.callint_make_invoice_ready();
        }
